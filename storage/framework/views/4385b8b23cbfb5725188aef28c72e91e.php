<?php # [BlazeFolded]:{flux::link}:{C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/link.blade.php}:{1787573014} ?>
<?php # [BlazeFolded]:{flux::button}:{C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/button/index.blade.php}:{1787573014} ?>
<?php # [BlazeFolded]:{flux::link}:{C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/link.blade.php}:{1787573014} ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('login.store')); ?>" class="flex flex-col gap-6">
            ...
            <!-- Email Address -->
            <?php if (!function_exists('_b1b3e986cbcd709addce28cb131e1d63')) { $__blaze->compile('C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/input/index.blade.php', $__blaze->compiledPath.'/b1b3e986cbcd709addce28cb131e1d63.php'); require $__blaze->compiledPath.'/b1b3e986cbcd709addce28cb131e1d63.php'; } ?>
...
<?php _b1b3e986cbcd709addce28cb131e1d63($__blaze, ['name' => 'email','label' => __('Email address'),'value' => old('email'),'type' => 'email','required' => true,'autofocus' => true,'autocomplete' => 'email','placeholder' => 'email@example.com'], [], ['label', 'value', 'required', 'autofocus'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _b1b3e986cbcd709addce28cb131e1d63($__blaze, ['name' => 'password','label' => __('Password'),'type' => 'password','required' => true,'autocomplete' => 'current-password','placeholder' => __('Password'),'viewable' => true], [], ['label', 'required', 'placeholder', 'viewable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            ...
            <!-- Remember Me -->
            <?php if (!function_exists('_a7fad8e5aa6d02fb58b49050beb3d275')) { $__blaze->compile('C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/checkbox/index.blade.php', $__blaze->compiledPath.'/a7fad8e5aa6d02fb58b49050beb3d275.php'); require $__blaze->compiledPath.'/a7fad8e5aa6d02fb58b49050beb3d275.php'; } ?>
<?php $__blaze->pushData(['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')]); ?>
<?php _a7fad8e5aa6d02fb58b49050beb3d275($__blaze, ['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')], [], ['label', 'checked'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\NTATU\Herd\curtainskenya\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>