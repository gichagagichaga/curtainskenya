...
<?php ob_start(); ?><ui-dropdown position="bottom start"  data-flux-dropdown>
    <?php ob_start(); ?>
    <?php if (!function_exists('_fdfc6832aeea48918e8ca6da4e6cb197')) { $__blaze->compile('C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/profile.blade.php', $__blaze->compiledPath.'/fdfc6832aeea48918e8ca6da4e6cb197.php'); require $__blaze->compiledPath.'/fdfc6832aeea48918e8ca6da4e6cb197.php'; } ?>
...
<?php _fdfc6832aeea48918e8ca6da4e6cb197($__blaze, ['name' => auth()->user()->name,'initials' => auth()->user()->initials(),'icon:trailing' => 'chevrons-up-down','dataTest' => 'sidebar-menu-button'], [], ['name', 'initials'], ['dataTest' => 'data-test'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
<?php /**PATH C:\Users\NTATU\Herd\curtainskenya\resources\views/components/desktop-user-menu.blade.php ENDPATH**/ ?>