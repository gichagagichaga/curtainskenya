<?php # [BlazeFolded]:{flux::label}:{C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/label.blade.php}:{1787573014} ?>
<?php # [BlazeFolded]:{flux::description}:{C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/description.blade.php}:{1787573014} ?>
<?php # [BlazeFolded]:{flux::field}:{C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/field.blade.php}:{1787573014} ?>
<?php
if (!function_exists('_20823f7189d3fd76f63b5eb61aea532b')):
function _20823f7189d3fd76f63b5eb61aea532b($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _46454072e6d5675708c21469e8cc39fe($__blaze, ['name' => $scope['name']], [], ['name'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/with-inline-field.blade.php ENDPATH**/ ?>