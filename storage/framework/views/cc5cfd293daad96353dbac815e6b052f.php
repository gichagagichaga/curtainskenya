<?php # [BlazeFolded]:{flux::icon.check}:{C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/check.blade.php}:{1787573014} ?>
<?php # [BlazeFolded]:{flux::icon.minus}:{C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/minus.blade.php}:{1787573014} ?>
<?php
if (!function_exists('_cc5cfd293daad96353dbac815e6b052f')):
function _cc5cfd293daad96353dbac815e6b052f($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/checkbox/indicator.blade.php ENDPATH**/ ?>