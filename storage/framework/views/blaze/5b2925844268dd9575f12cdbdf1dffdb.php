<?php
if (!function_exists('__5b2925844268dd9575f12cdbdf1dffdb')):
function __5b2925844268dd9575f12cdbdf1dffdb($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if (!function_exists('__de7aae5be0ba9f2e2171db5d23daa515')) { $__blaze->compile('C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/with-tooltip.blade.php', $__blaze->compiledPath.'/de7aae5be0ba9f2e2171db5d23daa515.php'); require $__blaze->compiledPath.'/de7aae5be0ba9f2e2171db5d23daa515.php'; } ?>
<?php if (isset($__slotsde7aae5be0ba9f2e2171db5d23daa515)) { $__slotsStackde7aae5be0ba9f2e2171db5d23daa515[] = $__slotsde7aae5be0ba9f2e2171db5d23daa515; } ?>
<?php if (isset($__attrsde7aae5be0ba9f2e2171db5d23daa515)) { $__attrsStackde7aae5be0ba9f2e2171db5d23daa515[] = $__attrsde7aae5be0ba9f2e2171db5d23daa515; } ?>
<?php $__attrsde7aae5be0ba9f2e2171db5d23daa515 = ['attributes' => $attributes]; ?>
<?php $__slotsde7aae5be0ba9f2e2171db5d23daa515 = []; ?>
<?php $__blaze->pushData($__attrsde7aae5be0ba9f2e2171db5d23daa515); ?>
<?php ob_start(); ?>
...
<?php $__attrsa6e8b4eb0adf1ab5452460622357a312 = ['type' => $type,'attributes' => $attributes->class($classes),'dataFluxButton' => true]; ?>
...
<?php __34af3e88ce3ae520ec9e8c7d3a539fe7($__blaze, ['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses], [], ['variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            </div>
        <?php endif; ?>
...
<?php __34af3e88ce3ae520ec9e8c7d3a539fe7($__blaze, ['icon' => $iconLeading,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php __34af3e88ce3ae520ec9e8c7d3a539fe7($__blaze, ['icon' => $iconTrailing,'variant' => $iconTrailingVariant,'class' => $iconTrailingClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php __a6e8b4eb0adf1ab5452460622357a312($__blaze, $__attrsa6e8b4eb0adf1ab5452460622357a312, $__slotsa6e8b4eb0adf1ab5452460622357a312, ['type', 'attributes', 'dataFluxButton'], ['dataFluxButton' => 'data-flux-button'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
<?php $__slotsde7aae5be0ba9f2e2171db5d23daa515['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsde7aae5be0ba9f2e2171db5d23daa515); ?>
<?php __de7aae5be0ba9f2e2171db5d23daa515($__blaze, $__attrsde7aae5be0ba9f2e2171db5d23daa515, $__slotsde7aae5be0ba9f2e2171db5d23daa515, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackde7aae5be0ba9f2e2171db5d23daa515)) { $__slotsde7aae5be0ba9f2e2171db5d23daa515 = array_pop($__slotsStackde7aae5be0ba9f2e2171db5d23daa515); } ?>
<?php if (! empty($__attrsStackde7aae5be0ba9f2e2171db5d23daa515)) { $__attrsde7aae5be0ba9f2e2171db5d23daa515 = array_pop($__attrsStackde7aae5be0ba9f2e2171db5d23daa515); } ?>
<?php $__blaze->popData(); ?>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/button/index.blade.php ENDPATH**/ ?>