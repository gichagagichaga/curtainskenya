<?php
if (!function_exists('__90b83954916fb6b3033824d5802cb8a7')):
function __90b83954916fb6b3033824d5802cb8a7($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if ($collapsibleOnMobile): ?>
    <?php if (!function_exists('__7521bca937a9317696901c29fc0e198a')) { $__blaze->compile('C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/backdrop.blade.php', $__blaze->compiledPath.'/7521bca937a9317696901c29fc0e198a.php'); require $__blaze->compiledPath.'/7521bca937a9317696901c29fc0e198a.php'; } ?>
<?php $__blaze->pushData([]); ?>
<?php __7521bca937a9317696901c29fc0e198a($__blaze, [], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
<?php endif; ?>
...
} endif; ?><?php /**PATH C:\Users\NTATU\Herd\curtainskenya\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/index.blade.php ENDPATH**/ ?>