...
@section('title', $category->name . ' | Curtains Kenya')

@section('description', $category->description ?: 'Explore ' . $category->name . ' from Curtains Kenya.')
    ...
    <div class="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-20">
        ...
        @else
            ...
            <div class="py-20 text-center">
                ...
                <a
                    href="{{ route('shop.index') }}"
                    class="mt-7 inline-flex bg-[#29231e] px-6 py-3 text-sm font-medium uppercase tracking-wider text-white transition hover:bg-[#463b33]"
                >
                    View All Products
                </a>
...
<section class="bg-[#29231e] text-white">
    ...
    <div class="mx-auto max-w-7xl px-6 py-16 text-center lg:px-8 lg:py-20">
        ...
        <h2 class="mx-auto mt-4 max-w-2xl font-serif text-3xl sm:text-4xl">
            Looking for something customised?
        </h2>

        <p class="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#d7cec5]">
            Talk to Curtains Kenya about custom curtains, blinds, bedding,
            seat covers and other interior textile requirements.
        </p>
